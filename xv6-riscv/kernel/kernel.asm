...
consoleinit(void)
{
  ...
  devsw[CONSOLE].read = consoleread;
    ...
    80000482:	74a78793          	addi	a5,a5,1866 # 80020bc8 <devsw>
...
kfree(void *pa)
{
  ...
  if(((uint64)pa % PGSIZE) != 0 || (char*)pa < end || (uint64)pa >= PHYSTOP)
    ...
    80000a16:	34e78793          	addi	a5,a5,846 # 80021d60 <end>
...
0000000080000abe <kinit>:
{
  ...
  freerange(end, (void*)PHYSTOP);
    ...
    80000ae6:	27e50513          	addi	a0,a0,638 # 80021d60 <end>
...
proc_mapstacks(pagetable_t kpgtbl)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001884:	100a0a13          	addi	s4,s4,256 # 80016980 <tickslock>
    char *pa = kalloc();
...
procinit(void)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001950:	03498993          	addi	s3,s3,52 # 80016980 <tickslock>
      initlock(&p->lock, "proc");
...
forkret(void)
{
  ...
  if (first) {
    ...
    80001a1a:	e2a7a783          	lw	a5,-470(a5) # 80008840 <first.1712>
  ...
  usertrapret();
    ...
    80001a34:	e007a823          	sw	zero,-496(a5) # 80008840 <first.1712>
    fsinit(ROOTDEV);
...
0000000080001bd0 <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001be8:	d9c90913          	addi	s2,s2,-612 # 80016980 <tickslock>
    acquire(&p->lock);
...
0000000080001c9e <userinit>:
{
  ...
  initproc = p;
    ...
    80001cb6:	c2a7b323          	sd	a0,-986(a5) # 800088d8 <initproc>
...
0000000080001d7c <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  acquire(&wait_lock);
    ...
    80001e6c:	d0048493          	addi	s1,s1,-768 # 80010b68 <wait_lock>
...
0000000080001eb8 <scheduler>:
{
  ...
  c->proc = 0;
    ...
    80001ed8:	c7c70713          	addi	a4,a4,-900 # 80010b50 <pid_lock>
    80001edc:	9756                	add	a4,a4,s5
    80001ede:	02073823          	sd	zero,48(a4)
        swtch(&c->context, &p->context);
    80001ee2:	0000f717          	auipc	a4,0xf
    80001ee6:	ca670713          	addi	a4,a4,-858 # 80010b88 <cpus+0x8>
    ...
    80001ef6:	c5ea0a13          	addi	s4,s4,-930 # 80010b50 <pid_lock>
    80001efa:	9a3e                	add	s4,s4,a5
    for(p = proc; p < &proc[NPROC]; p++) {
    80001efc:	00015917          	auipc	s2,0x15
    80001f00:	a8490913          	addi	s2,s2,-1404 # 80016980 <tickslock>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001f14:	07048493          	addi	s1,s1,112 # 80010f80 <proc>
...
0000000080001f58 <sched>:
{
  ...
  if(mycpu()->noff != 1)
    ...
    80001f84:	bd070713          	addi	a4,a4,-1072 # 80010b50 <pid_lock>
  ...
  intena = mycpu()->intena;
    ...
    80001faa:	baa90913          	addi	s2,s2,-1110 # 80010b50 <pid_lock>
  ...
  swtch(&p->context, &mycpu()->context);
    ...
    80001fc2:	bca58593          	addi	a1,a1,-1078 # 80010b88 <cpus+0x8>
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800020e6:	e9e48493          	addi	s1,s1,-354 # 80010f80 <proc>
    if(p != myproc()){
      acquire(&p->lock);
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800020f2:	89290913          	addi	s2,s2,-1902 # 80016980 <tickslock>
...
0000000080002144 <reparent>:
{
  ...
  for(pp = proc; pp < &proc[NPROC]; pp++){
    ...
    8000215a:	e2a48493          	addi	s1,s1,-470 # 80010f80 <proc>
      pp->parent = initproc;
    8000215e:	00006a17          	auipc	s4,0x6
    80002162:	77aa0a13          	addi	s4,s4,1914 # 800088d8 <initproc>
  for(pp = proc; pp < &proc[NPROC]; pp++){
    80002166:	00015997          	auipc	s3,0x15
    8000216a:	81a98993          	addi	s3,s3,-2022 # 80016980 <tickslock>
...
000000008000219e <exit>:
{
  ...
  if(p == initproc)
    ...
    800021be:	71e7b783          	ld	a5,1822(a5) # 800088d8 <initproc>
  ...
  acquire(&wait_lock);
    ...
    8000221a:	95248493          	addi	s1,s1,-1710 # 80010b68 <wait_lock>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80002288:	cfc48493          	addi	s1,s1,-772 # 80010f80 <proc>
    8000228c:	00014997          	auipc	s3,0x14
    80002290:	6f498993          	addi	s3,s3,1780 # 80016980 <tickslock>
    acquire(&p->lock);
...
0000000080002344 <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    8000236c:	80050513          	addi	a0,a0,-2048 # 80010b68 <wait_lock>
    ...
    80002380:	60498993          	addi	s3,s3,1540 # 80016980 <tickslock>
        havekids = 1;
    80002384:	4a85                	li	s5,1
    sleep(p, &wait_lock);  //DOC: wait-sleep
    80002386:	0000ec17          	auipc	s8,0xe
    8000238a:	7e2c0c13          	addi	s8,s8,2018 # 80010b68 <wait_lock>
    havekids = 0;
    8000238e:	875e                	mv	a4,s7
    for(pp = proc; pp < &proc[NPROC]; pp++){
    80002390:	0000f497          	auipc	s1,0xf
    80002394:	bf048493          	addi	s1,s1,-1040 # 80010f80 <proc>
    ...
    800023d2:	79a50513          	addi	a0,a0,1946 # 80010b68 <wait_lock>
    ...
    800023ee:	77e50513          	addi	a0,a0,1918 # 80010b68 <wait_lock>
    ...
    8000243c:	73050513          	addi	a0,a0,1840 # 80010b68 <wait_lock>
...
procdump(void)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80002548:	b9448493          	addi	s1,s1,-1132 # 800110d8 <proc+0x158>
    8000254c:	00014917          	auipc	s2,0x14
    80002550:	58c90913          	addi	s2,s2,1420 # 80016ad8 <bcache+0x140>
    if(p->state == UNUSED)
      continue;
    ...
    80002572:	d5ab8b93          	addi	s7,s7,-678 # 800082c8 <states.1756>
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80002642:	cba58593          	addi	a1,a1,-838 # 800082f8 <states.1756+0x30>
    80002646:	00014517          	auipc	a0,0x14
    8000264a:	33a50513          	addi	a0,a0,826 # 80016980 <tickslock>
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    8000271a:	26a48493          	addi	s1,s1,618 # 80016980 <tickslock>
  ...
  ticks++;
    ...
    8000272c:	1b850513          	addi	a0,a0,440 # 800088e0 <ticks>
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    800027a4:	b6050513          	addi	a0,a0,-1184 # 80008300 <states.1756+0x38>
...
00000000800027f4 <usertrap>:
{
  ...
  if(killed(p))
    ...
    80002850:	ad450513          	addi	a0,a0,-1324 # 80008320 <states.1756+0x58>
  ...
  asm volatile("csrr %0, scause" : "=r" (x) );
    ...
    800028ca:	a7a50513          	addi	a0,a0,-1414 # 80008340 <states.1756+0x78>
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    800028e2:	a9250513          	addi	a0,a0,-1390 # 80008370 <states.1756+0xa8>
...
0000000080002904 <kerneltrap>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80002956:	a3e50513          	addi	a0,a0,-1474 # 80008390 <states.1756+0xc8>
    8000295a:	ffffe097          	auipc	ra,0xffffe
    8000295e:	bea080e7          	jalr	-1046(ra) # 80000544 <panic>
    panic("kerneltrap: interrupts enabled");
    80002962:	00006517          	auipc	a0,0x6
    80002966:	a5650513          	addi	a0,a0,-1450 # 800083b8 <states.1756+0xf0>
    ...
    80002978:	a6450513          	addi	a0,a0,-1436 # 800083d8 <states.1756+0x110>
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80002990:	a5c50513          	addi	a0,a0,-1444 # 800083e8 <states.1756+0x120>
    80002994:	ffffe097          	auipc	ra,0xffffe
    80002998:	bfa080e7          	jalr	-1030(ra) # 8000058e <printf>
    panic("kerneltrap");
    8000299c:	00006517          	auipc	a0,0x6
    800029a0:	a6450513          	addi	a0,a0,-1436 # 80008400 <states.1756+0x138>
...
argraw(int n)
{
  ...
  switch (n) {
    ...
    800029f0:	a4c70713          	addi	a4,a4,-1460 # 80008438 <states.1756+0x170>
  ...
  panic("argraw");
    ...
    80002a2c:	9e850513          	addi	a0,a0,-1560 # 80008410 <states.1756+0x148>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    80002b9c:	88050513          	addi	a0,a0,-1920 # 80008418 <states.1756+0x150>
...
sys_sleep(void)
{
  ...
  while(ticks - ticks0 < n){
    ...
    80002cc2:	cc298993          	addi	s3,s3,-830 # 80016980 <tickslock>
    80002cc6:	00006497          	auipc	s1,0x6
    80002cca:	c1a48493          	addi	s1,s1,-998 # 800088e0 <ticks>
    if(killed(myproc())){
  ...
  release(&tickslock);
    ...
    80002cfe:	c8650513          	addi	a0,a0,-890 # 80016980 <tickslock>
  ...
  return 0;
    ...
    80002d1e:	c6650513          	addi	a0,a0,-922 # 80016980 <tickslock>
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002d66:	c1e50513          	addi	a0,a0,-994 # 80016980 <tickslock>
    80002d6a:	ffffe097          	auipc	ra,0xffffe
    80002d6e:	e80080e7          	jalr	-384(ra) # 80000bea <acquire>
  xticks = ticks;
    80002d72:	00006497          	auipc	s1,0x6
    80002d76:	b6e4a483          	lw	s1,-1170(s1) # 800088e0 <ticks>
  release(&tickslock);
    80002d7a:	00014517          	auipc	a0,0x14
    80002d7e:	c0650513          	addi	a0,a0,-1018 # 80016980 <tickslock>
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002db6:	be650513          	addi	a0,a0,-1050 # 80016998 <bcache>
  ...
  bcache.head.prev = &bcache.head;
    ...
    80002dc6:	bd678793          	addi	a5,a5,-1066 # 8001e998 <bcache+0x8000>
    80002dca:	0001c717          	auipc	a4,0x1c
    80002dce:	e3670713          	addi	a4,a4,-458 # 8001ec00 <bcache+0x8268>
    80002dd2:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    80002dd6:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80002dda:	00014497          	auipc	s1,0x14
    80002dde:	bd648493          	addi	s1,s1,-1066 # 800169b0 <bcache+0x18>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    80002e3e:	b5e50513          	addi	a0,a0,-1186 # 80016998 <bcache>
    80002e42:	ffffe097          	auipc	ra,0xffffe
    80002e46:	da8080e7          	jalr	-600(ra) # 80000bea <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    80002e4a:	0001c497          	auipc	s1,0x1c
    80002e4e:	e064b483          	ld	s1,-506(s1) # 8001ec50 <bcache+0x82b8>
    80002e52:	0001c797          	auipc	a5,0x1c
    80002e56:	dae78793          	addi	a5,a5,-594 # 8001ec00 <bcache+0x8268>
    ...
    80002e7e:	b1e50513          	addi	a0,a0,-1250 # 80016998 <bcache>
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    ...
    80002e9c:	db04b483          	ld	s1,-592(s1) # 8001ec48 <bcache+0x82b0>
    80002ea0:	0001c797          	auipc	a5,0x1c
    80002ea4:	d6078793          	addi	a5,a5,-672 # 8001ec00 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    80002edc:	ac050513          	addi	a0,a0,-1344 # 80016998 <bcache>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    80002f84:	a1850513          	addi	a0,a0,-1512 # 80016998 <bcache>
  ...
  if (b->refcnt == 0) {
    ...
    80002fac:	9f078793          	addi	a5,a5,-1552 # 8001e998 <bcache+0x8000>
    80002fb0:	2b87b703          	ld	a4,696(a5)
    80002fb4:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    80002fb6:	0001c717          	auipc	a4,0x1c
    80002fba:	c4a70713          	addi	a4,a4,-950 # 8001ec00 <bcache+0x8268>
  ...
  release(&bcache.lock);
    ...
    80002fce:	9ce50513          	addi	a0,a0,-1586 # 80016998 <bcache>
...
bpin(struct buf *b) {
  ...
  release(&bcache.lock);
    ...
    8000301c:	98050513          	addi	a0,a0,-1664 # 80016998 <bcache>
...
bunpin(struct buf *b) {
  ...
  release(&bcache.lock);
    ...
    80003058:	94450513          	addi	a0,a0,-1724 # 80016998 <bcache>
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    ...
    80003084:	ff47a783          	lw	a5,-12(a5) # 8001f074 <sb+0x1c>
...
00000000800030ea <balloc>:
{
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    80003108:	f587a783          	lw	a5,-168(a5) # 8001f05c <sb+0x4>
    ...
    80003118:	f44b0b13          	addi	s6,s6,-188 # 8001f058 <sb>
...
000000008000330a <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    80003322:	d5a50513          	addi	a0,a0,-678 # 8001f078 <itable>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80003334:	d6048493          	addi	s1,s1,-672 # 8001f090 <itable+0x18>
    80003338:	0001d697          	auipc	a3,0x1d
    8000333c:	7e868693          	addi	a3,a3,2024 # 80020b20 <log>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80003368:	d1450513          	addi	a0,a0,-748 # 8001f078 <itable>
  ...
  release(&itable.lock);
    ...
    80003398:	ce450513          	addi	a0,a0,-796 # 8001f078 <itable>
...
fsinit(int dev) {
  ...
  memmove(sb, bp->data, sizeof(*sb));
    ...
    800033e6:	c7698993          	addi	s3,s3,-906 # 8001f058 <sb>
  ...
  initlog(dev, &sb);
    ...
    8000341a:	c4258593          	addi	a1,a1,-958 # 8001f058 <sb>
...
0000000080003446 <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80003460:	c1c50513          	addi	a0,a0,-996 # 8001f078 <itable>
    80003464:	ffffd097          	auipc	ra,0xffffd
    80003468:	6f6080e7          	jalr	1782(ra) # 80000b5a <initlock>
  for(i = 0; i < NINODE; i++) {
    8000346c:	0001c497          	auipc	s1,0x1c
    80003470:	c3448493          	addi	s1,s1,-972 # 8001f0a0 <itable+0x28>
    80003474:	0001d997          	auipc	s3,0x1d
    80003478:	6bc98993          	addi	s3,s3,1724 # 80020b30 <log+0x10>
...
00000000800034a6 <ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    ...
    800034c0:	ba872703          	lw	a4,-1112(a4) # 8001f064 <sb+0xc>
    ...
    800034d4:	b88a0a13          	addi	s4,s4,-1144 # 8001f058 <sb>
...
0000000080003578 <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80003590:	ae45a583          	lw	a1,-1308(a1) # 8001f070 <sb+0x18>
...
0000000080003604 <idup>:
{
  ...
  release(&itable.lock);
    ...
    8000362a:	a5250513          	addi	a0,a0,-1454 # 8001f078 <itable>
...
0000000080003642 <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    8000368c:	9e85a583          	lw	a1,-1560(a1) # 8001f070 <sb+0x18>
...
00000000800037fc <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    8000380e:	86e50513          	addi	a0,a0,-1938 # 8001f078 <itable>
  ...
  release(&itable.lock);
    ...
    8000382c:	85050513          	addi	a0,a0,-1968 # 8001f078 <itable>
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80003860:	81c50513          	addi	a0,a0,-2020 # 8001f078 <itable>
    ...
    80003896:	7e650513          	addi	a0,a0,2022 # 8001f078 <itable>
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    ...
    80003e32:	cf290913          	addi	s2,s2,-782 # 80020b20 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003e56:	cfe78793          	addi	a5,a5,-770 # 80020b50 <log+0x30>
    ...
    80003e6a:	cee60613          	addi	a2,a2,-786 # 80020b54 <log+0x34>
...
0000000080003e9c <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80003ea0:	cb07a783          	lw	a5,-848(a5) # 80020b4c <log+0x2c>
    80003ea4:	0af05d63          	blez	a5,80003f5e <install_trans+0xc2>
{
    ...
    80003ec2:	c92a8a93          	addi	s5,s5,-878 # 80020b50 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    80003ec6:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80003ec8:	0001d997          	auipc	s3,0x1d
    80003ecc:	c5898993          	addi	s3,s3,-936 # 80020b20 <log>
...
0000000080003f60 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    80003f76:	bae48493          	addi	s1,s1,-1106 # 80020b20 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003fb6:	b9e68693          	addi	a3,a3,-1122 # 80020b50 <log+0x30>
...
recover_from_log(void)
{
  ...
  log.lh.n = 0;
    ...
    80003fea:	b607a323          	sw	zero,-1178(a5) # 80020b4c <log+0x2c>
...
begin_op(void)
{
  ...
  while(1){
    ...
    8000406a:	aba50513          	addi	a0,a0,-1350 # 80020b20 <log>
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    8000409a:	a8a48493          	addi	s1,s1,-1398 # 80020b20 <log>
  ...
  if(log.outstanding == 0){
    ...
    800040be:	a6648493          	addi	s1,s1,-1434 # 80020b20 <log>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    800040da:	a4a48493          	addi	s1,s1,-1462 # 80020b20 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80004144:	a10a8a93          	addi	s5,s5,-1520 # 80020b50 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    80004148:	0001da17          	auipc	s4,0x1d
    8000414c:	9d8a0a13          	addi	s4,s4,-1576 # 80020b20 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    800041ce:	9807a123          	sw	zero,-1662(a5) # 80020b4c <log+0x2c>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    800041ee:	93690913          	addi	s2,s2,-1738 # 80020b20 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    8000422c:	92870713          	addi	a4,a4,-1752 # 80020b50 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  log.lh.block[i] = b->blockno;
    ...
    80004248:	8dc78793          	addi	a5,a5,-1828 # 80020b20 <log>
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    80004260:	8c470713          	addi	a4,a4,-1852 # 80020b20 <log>
  ...
  log.lh.block[i] = b->blockno;
    ...
    80004298:	88c70713          	addi	a4,a4,-1908 # 80020b20 <log>
  ...
  release(&log.lock);
    ...
    800042aa:	87a50513          	addi	a0,a0,-1926 # 80020b20 <log>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    80004400:	86c50513          	addi	a0,a0,-1940 # 80020c68 <ftable>
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    80004422:	84a50513          	addi	a0,a0,-1974 # 80020c68 <ftable>
    80004426:	ffffc097          	auipc	ra,0xffffc
    8000442a:	7c4080e7          	jalr	1988(ra) # 80000bea <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    8000442e:	0001d497          	auipc	s1,0x1d
    80004432:	85248493          	addi	s1,s1,-1966 # 80020c80 <ftable+0x18>
    80004436:	0001d717          	auipc	a4,0x1d
    8000443a:	7ea70713          	addi	a4,a4,2026 # 80021c20 <disk>
    if(f->ref == 0){
  ...
  release(&ftable.lock);
    ...
    8000444e:	81e50513          	addi	a0,a0,-2018 # 80020c68 <ftable>
  ...
  return 0;
    ...
    80004466:	80650513          	addi	a0,a0,-2042 # 80020c68 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    8000448e:	7de50513          	addi	a0,a0,2014 # 80020c68 <ftable>
  ...
  release(&ftable.lock);
    ...
    800044a8:	7c450513          	addi	a0,a0,1988 # 80020c68 <ftable>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800044e8:	78450513          	addi	a0,a0,1924 # 80020c68 <ftable>
  ...
  release(&ftable.lock);
    ...
    80004522:	74a50513          	addi	a0,a0,1866 # 80020c68 <ftable>
  ...
  if(ff.type == FD_PIPE){
    ...
    8000456c:	70050513          	addi	a0,a0,1792 # 80020c68 <ftable>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    8000469e:	52e70713          	addi	a4,a4,1326 # 80020bc8 <devsw>
...
filewrite(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    8000473e:	48e70713          	addi	a4,a4,1166 # 80020bc8 <devsw>
...
fdalloc(struct file *f)
{
  ...
  for(fd = 0; fd < NOFILE; fd++){
    80004f6e:	0d050793          	addi	a5,a0,208 # fffffffffffff0d0 <end+0xffffffff7ffdd370>
...
0000000080005ce8 <virtio_disk_init>:
{
  ...
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  disk.desc = kalloc();
    ...
    80005dae:	e7648493          	addi	s1,s1,-394 # 80021c20 <disk>
  ...
  if(!disk.desc || !disk.avail || !disk.used)
    ...
    80005dd2:	e5a73703          	ld	a4,-422(a4) # 80021c28 <disk+0x8>
  ...
  memset(disk.avail, 0, PGSIZE);
    ...
    80005dea:	e3a48493          	addi	s1,s1,-454 # 80021c20 <disk>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80005f0a:	e4250513          	addi	a0,a0,-446 # 80021d48 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80005f1e:	d06b0b13          	addi	s6,s6,-762 # 80021c20 <disk>
  for(int i = 0; i < 3; i++){
  ...
  while(1){
    ...
    80005f2a:	e22c0c13          	addi	s8,s8,-478 # 80021d48 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80005f4c:	cd868693          	addi	a3,a3,-808 # 80021c20 <disk>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80005f9e:	c9e50513          	addi	a0,a0,-866 # 80021c38 <disk+0x18>
  ...
  if(write)
    ...
    80005fbe:	c6678793          	addi	a5,a5,-922 # 80021c20 <disk>
  ...
  buf0->reserved = 0;
    ...
    80005fcc:	c5858593          	addi	a1,a1,-936 # 80021c20 <disk>
  ...
  disk.info[idx[0]].status = 0xff; // device writes 0 on success
    ...
    80006034:	bf068693          	addi	a3,a3,-1040 # 80021c20 <disk>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    800060a6:	ca698993          	addi	s3,s3,-858 # 80021d48 <disk+0x128>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    800060d0:	b5478793          	addi	a5,a5,-1196 # 80021c20 <disk>
    800060d4:	97ba                	add	a5,a5,a4
    800060d6:	0007b423          	sd	zero,8(a5)
    int flag = disk.desc[i].flags;
    800060da:	0001c997          	auipc	s3,0x1c
    800060de:	b4698993          	addi	s3,s3,-1210 # 80021c20 <disk>
  ...
  release(&disk.vdisk_lock);
    ...
    80006106:	c4650513          	addi	a0,a0,-954 # 80021d48 <disk+0x128>
  ...
  struct virtio_blk_req *buf0 = &disk.ops[idx[0]];
    ...
    80006144:	ae850513          	addi	a0,a0,-1304 # 80021c28 <disk+0x8>
  ...
  if(write)
    ...
    8000615a:	aca78793          	addi	a5,a5,-1334 # 80021c20 <disk>
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80006174:	ab048493          	addi	s1,s1,-1360 # 80021c20 <disk>
    80006178:	0001c517          	auipc	a0,0x1c
    8000617c:	bd050513          	addi	a0,a0,-1072 # 80021d48 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    800061f4:	b5850513          	addi	a0,a0,-1192 # 80021d48 <disk+0x128>
...
000000008000621a <init_list_head>:
#include "defs.h"
#include "spinlock.h"
#include "proc.h"
...
void init_list_head(struct list_head *list)
{
  ...
  list->next = list;
    80006220:	e108                	sd	a0,0(a0)
  list->prev = list;
    80006222:	e508                	sd	a0,8(a0)
}
    80006224:	6422                	ld	s0,8(sp)
    80006226:	0141                	addi	sp,sp,16
    80006228:	8082                	ret

000000008000622a <list_add>:
  next->prev = prev;
  prev->next = next;
}
...
void list_add(struct list_head *head, struct list_head *new)
{
  ...
  __list_add(new, head, head->next);
    80006230:	611c                	ld	a5,0(a0)
  next->prev = new;
    80006232:	e78c                	sd	a1,8(a5)
  new->next = next;
    80006234:	e19c                	sd	a5,0(a1)
  new->prev = prev;
    80006236:	e588                	sd	a0,8(a1)
  prev->next = new;
    80006238:	e10c                	sd	a1,0(a0)
}
    8000623a:	6422                	ld	s0,8(sp)
    8000623c:	0141                	addi	sp,sp,16
    8000623e:	8082                	ret

0000000080006240 <list_add_tail>:
...
void list_add_tail(struct list_head *head, struct list_head *new)
{
  ...
  __list_add(new, head->prev, head);
    80006246:	651c                	ld	a5,8(a0)
  next->prev = new;
    80006248:	e50c                	sd	a1,8(a0)
  new->next = next;
    8000624a:	e188                	sd	a0,0(a1)
  new->prev = prev;
    8000624c:	e59c                	sd	a5,8(a1)
  prev->next = new;
    8000624e:	e38c                	sd	a1,0(a5)
}
    80006250:	6422                	ld	s0,8(sp)
    80006252:	0141                	addi	sp,sp,16
    80006254:	8082                	ret

0000000080006256 <list_del>:
...
void list_del(struct list_head *entry)
{
  ...
  __list_del(entry->prev, entry->next);
    8000625c:	651c                	ld	a5,8(a0)
    8000625e:	6118                	ld	a4,0(a0)
  next->prev = prev;
    80006260:	e71c                	sd	a5,8(a4)
  prev->next = next;
    80006262:	e398                	sd	a4,0(a5)
  entry->prev = entry->next = entry;
    80006264:	e108                	sd	a0,0(a0)
    80006266:	e508                	sd	a0,8(a0)
}
    80006268:	6422                	ld	s0,8(sp)
    8000626a:	0141                	addi	sp,sp,16
    8000626c:	8082                	ret

000000008000626e <list_del_init>:
...
void list_del_init(struct list_head *entry)
{
  ...
  __list_del(entry->prev, entry->next);
    80006274:	651c                	ld	a5,8(a0)
    80006276:	6118                	ld	a4,0(a0)
  next->prev = prev;
    80006278:	e71c                	sd	a5,8(a4)
  prev->next = next;
    8000627a:	e398                	sd	a4,0(a5)
  list->next = list;
    8000627c:	e108                	sd	a0,0(a0)
  list->prev = list;
    8000627e:	e508                	sd	a0,8(a0)
  init_list_head(entry);
}
    80006280:	6422                	ld	s0,8(sp)
